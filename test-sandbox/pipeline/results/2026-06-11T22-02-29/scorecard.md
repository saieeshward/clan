# CLAN scorecard — 2026-06-11T22-02-29

CLI: clan 1.1.0 · cargo: 0p/0f · conformance: 26/26
...
| **C-REVISION-TOKENS** Revision-loop pipelines: CLAN patch path authors materially fewer output chars t | FAIL | 0.652 | <= 0.65 |
| **C-PROV-E2E** A revision pipeline's final chain attributes every mutating hop | KNOWN-RED | 0.125 | >= 1.0 |
| **C-CROSSOVER** Sequential chains: CLAN distilled re-injection beats ad-hoc accumulating re-read | NO-DATA |  | <= 10 |
| **C-SYNTH-WIN** At the synthesis hop, CLAN's merged injection beats ad-hoc re-reading all inputs | PASS | 0.776 | < 1.0 |
...
Expect-red now GREEN (update claims.yaml): T20