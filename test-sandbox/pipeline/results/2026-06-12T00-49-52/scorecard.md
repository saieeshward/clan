# CLAN scorecard — 2026-06-12T00-49-52
...
| **C-REVISION-TOKENS** Revision-loop pipelines: CLAN patch path authors materially fewer output chars t | PASS | 0.576 | <= 0.65 |
| **C-PROV-E2E** A revision pipeline's final chain attributes every mutating hop | PASS | 1.125 | >= 1.0 |
| **C-CROSSOVER** Sequential chains: CLAN distilled re-injection beats ad-hoc accumulating re-read | NO-DATA |  | <= 10 |
| **C-SYNTH-WIN** At the synthesis hop, CLAN's merged injection beats ad-hoc re-reading all inputs | PASS | 0.557 | < 1.0 |
