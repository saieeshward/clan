...
1-year Zoho contract is procurable in ~4 wks; push annual prepay + a competitor quote for discount, demand a 60-day opt-out to kill auto-renew lock-in, and the quarterly export clause is feasible. Next: lead partner assembles the recommendation.

## 11-legal-reviewer
Zoho is EU-resident so SCCs suffice (no real transfer); DPA required and available. Watch the 1x-fees liability cap and thin IP indemnity — negotiate a breach super-cap and an IP indemnity clause. Next: lead partner assembles the recommendation.
