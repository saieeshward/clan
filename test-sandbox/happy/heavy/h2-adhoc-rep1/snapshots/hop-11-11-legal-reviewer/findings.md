...
procurement_key_commitments: ["EU pinning", "DPA signed", "quarterly export"]
procurement_negotiation_leverage: ["annual prepay", "multi-year option", "competitor quote"]
procurement_risks: [{risk: auto-renew lock-in, severity: Medium, mitigation: 60d opt-out clause}, {risk: seat overage fees, severity: Low, mitigation: cap at 40+10 tier}]
procurement_export_clause_feasible: true

## 11-legal-reviewer
legal_dpa_required: true
legal_gdpr_transfer_mechanism: SCCs
legal_liability_cap_eur: 18240
legal_ip_ownership_clear: true
legal_indemnification_adequate: false
legal_risks: [{risk: 1x-fee cap+weak IP indemnity, severity: Med, mitigation: 2x super-cap+IP clause}]
...
procurement_negotiation_leverage: ["prepay", "quote"]
procurement_risks: [{risk: auto-renew, severity: Med, mitigation: 60d opt-out}]
procurement_export_clause_feasible: true
...
legal_ip_ownership_clear: true
legal_indemnification_adequate: false
legal_risks: [{risk: 1x-fee cap+thin IP indemnity, severity: Med, mitigation: 2x super-cap+IP indemnity clause}]
