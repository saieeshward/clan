...
- procurement_key_commitments: EU pinning incl, quarterly export, DPA signed
- procurement_negotiation_leverage: low switch cost, Zoho-vs-HubSpot bake-off
- procurement_risks: renewal uplift (Med) -> cap clause
- procurement_export_clause_feasible: true

## 11-legal-reviewer
- legal_dpa_required: true
- legal_gdpr_transfer_mechanism: SCCs+EU pinning (no transfer)
- legal_liability_cap_eur: 18240
- legal_ip_ownership_clear: true
- legal_indemnification_adequate: true
- legal_risks: [{"risk":"renewal uplift","severity":"Med","mitigation":"cap clause"},{"risk":"subprocessor change","severity":"Low","mitigation":"30d notice"}]
...
- procurement_lead_time_weeks: 4
- procurement_contract_term_years: 1
- procurement_key_commitments: EU pin, Q exp, DPA
- procurement_negotiation_leverage: bakeoff
- procurement_risks: renewal hike (Med) -> cap
- procurement_export_clause_feasible: true

## 11-legal-reviewer
- legal_dpa_required: true
- legal_gdpr_transfer_mechanism: SCCs+EU-pin
- legal_liability_cap_eur: 18240
- legal_ip_ownership_clear: true
- legal_indemnification_adequate: true
- legal_risks: [{"risk":"renewal uplift","severity":"Med","mit":"cap"},{"risk":"subproc swap","severity":"Low","mit":"30d"}]
