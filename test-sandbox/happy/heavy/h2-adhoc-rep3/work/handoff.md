...
Zoho is cheapest at EUR18,240/yr for 40 seats vs HubSpot 24,000. Salesforce is out on cost. Next: risk-weight the two finalists.
...
Zoho 1-year contract, 3-week lead time; key levers are HubSpot walk-away quote and October deadline urgency; export clause confirmed feasible; price cap and EUR invoicing should be negotiated at signing. Next: lead partner assembles final recommendation.

## 11-legal-reviewer

DPA is mandatory before go-live; liability cap (1× annual fees) is inadequate for breach exposure — negotiate 2× or a breach carve-out; indemnification must be expanded to cover regulatory fines from vendor-side failures; governing law should be pinned to EU jurisdiction. Next: lead partner assembles final recommendation.
