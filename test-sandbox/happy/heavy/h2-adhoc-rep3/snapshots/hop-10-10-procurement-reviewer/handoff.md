...
2-yr Zoho term, ~4wk procurement lead. Use Salesforce quote + low switch cost as leverage; cap renewal uplift. Quarterly export clause is contractually feasible. Next: lead partner assembles recommendation.

## 11-legal-reviewer
DPA required and available; EU-only data means no transfer mechanism needed (SCCs as fallback). IP/indemnity adequate; push liability cap to 2x annual fees (~EUR36,480). Next: lead partner assembles recommendation.
...
## 10-procurement-reviewer
2-yr Zoho term, ~4wk procurement lead; leverage SF quote + low switch cost to cap renewal uplift; quarterly export clause feasible. Next: lead partner assembles recommendation.
