...
- procurement_contract_term_years: 2
- procurement_key_commitments: EU region pinning, annual prepay, SLA 99.9, 30-day subprocessor notice
- procurement_negotiation_leverage: Salesforce counter-quote, low switching cost, October peak deadline
- procurement_risks: [{renewal price uplift, Medium, negotiate cap}, {connector dependency, Low, written support commitment}]
- procurement_export_clause_feasible: true

## 11-legal-reviewer
- legal_dpa_required: true
- legal_gdpr_transfer_mechanism: EU-only (SCC fallback)
- legal_liability_cap_eur: 36480
- legal_ip_ownership_clear: true
- legal_indemnification_adequate: true
- legal_risks: [{cap<1x fees, Med, push 2x cap}, {subproc SCCs, Low, pin EU in DPA}]
...
- procurement_lead_time_weeks: 4
- procurement_contract_term_years: 2
- procurement_key_commitments: EU pin, prepay
- procurement_negotiation_leverage: SF quote, low switch
- procurement_risks: [{renewal, Med, cap}]
- procurement_export_clause_feasible: true

## 11-legal-reviewer
- legal_dpa_required: true
- legal_gdpr_transfer_mechanism: none (EU-only; SCC fallback)
- legal_liability_cap_eur: 36480
- legal_ip_ownership_clear: true
- legal_indemnification_adequate: true
- legal_risks: [{cap<1x fees,Med,push 2x},{subproc SCCs,Low,pin EU in DPA}]
