...
market_incumbent_share: HubSpot 34, Zoho 21, Salesforce 29
...
procurement_lead_time_weeks: 4
procurement_contract_term_years: 1
procurement_key_commitments: EU pinning, quarterly export, DPA
procurement_negotiation_leverage: annual prepay, multi-year option, competing bids
procurement_risks: [{"risk":"auto-renew lock","severity":"Medium","mitigation":"60d opt-out"},{"risk":"price uplift Y2","severity":"Medium","mitigation":"cap clause"}]
procurement_export_clause_feasible: true

## 11-legal-reviewer
legal_dpa_required: true
legal_gdpr_transfer_mechanism: SCCs+EU-pinning
legal_liability_cap_eur: 36480
legal_ip_ownership_clear: true
legal_indemnification_adequate: false
legal_risks: [{"risk":"liab cap=2x fees","severity":"Medium","mitigation":"raise to 3x"},{"risk":"weak IP indemnity","severity":"Medium","mitigation":"add IP indemn clause"}]
...
procurement_lead_time_weeks: 4
procurement_contract_term_years: 1
procurement_key_commitments: ["EU pin", "DPA"]
procurement_negotiation_leverage: ["prepay"]
procurement_risks: [{"risk":"renew","severity":"Med","mitigation":"60d opt-out"}]
procurement_export_clause_feasible: true

## 11-legal-reviewer
legal_dpa_required: true
legal_gdpr_transfer_mechanism: SCCs+EUpin
legal_liability_cap_eur: 36480
legal_ip_ownership_clear: true
legal_indemnification_adequate: false
legal_risks: [{"risk":"lo cap","severity":"Med","mitigation":"3x"},{"risk":"weak IP indemn","severity":"Med","mitigation":"clause"}]
