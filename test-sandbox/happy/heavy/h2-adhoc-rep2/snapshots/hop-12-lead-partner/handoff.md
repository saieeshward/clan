...
Market favours fast EU-resident go-lives. HubSpot leads mindshare but Zoho is gaining in mid-market on price. Next: 02-pricing-analyst should get hard per-seat pricing for all three vendors.

## 02-pricing-analyst
Zoho is cheapest at EUR18,240/yr for 40 seats vs HubSpot 24,000. Salesforce is out on cost. Next: 03-risk-analyst should risk-weight the two finalists (Zoho vs HubSpot).
...
Zoho procurable in ~4wk on a 1yr term; push annual prepay + Y2 price cap and a 60-day auto-renew opt-out. Export clause confirmed contractable. Next: lead partner assembles recommendation.

## 11-legal-reviewer
DPA + SCCs with EU pinning cover transfers; customer data IP is clear. Liability cap (~2x annual fees) and IP indemnity are thin — negotiate 3x cap + explicit IP indemnification before signing. Next: lead partner assembles recommendation.
...
## 11-legal-reviewer
DPA+SCCs with EU pinning cover transfers; data IP clear. Liability cap ~2x fees and IP indemnity are thin - negotiate 3x cap + explicit IP indemnification before signing. Next: lead partner assembles recommendation.
