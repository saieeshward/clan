...
Zoho: 1-yr term, ~4 wk lead time, annual prepay with EU pinning + quarterly export committed; negotiate renewal-uplift cap using HubSpot quote as leverage. Next: lead partner assembles recommendation.

## 11-legal-reviewer
Zoho DPA + EU pinning means no third-country transfer (SCCs as fallback); IP ownership clear, indemnification adequate, liability cap ~2x annual fees. Watch connector IP carve-out. Next: lead partner assembles recommendation.
