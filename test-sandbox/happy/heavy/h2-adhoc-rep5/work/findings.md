...
- procurement_key_commitments: annual prepay, EU region pinning, quarterly data export
- procurement_negotiation_leverage: competing HubSpot quote, multi-year option, 40-seat volume
- procurement_risks: price uplift at renewal (Medium, cap in contract); auto-renew lock-in (Low, opt-out clause)
- procurement_export_clause_feasible: true

## 11-legal-reviewer
- legal_dpa_required: true
- legal_gdpr_transfer_mechanism: EU-pinned, no transfer (SCCs fallback)
- legal_liability_cap_eur: 36480
- legal_ip_ownership_clear: true
- legal_indemnification_adequate: true
- legal_risks: [{IP indemnity carve-out for connectors, Medium, add NetSuite-connector warranty}, {liability cap = 2x fees, Low, accept market-standard}, {auto-renew, Low, opt-out clause}]
...
- procurement_lead_time_weeks: 4
- procurement_contract_term_years: 1
- procurement_key_commitments: prepay, EU pin
- procurement_negotiation_leverage: HS quote, volume
- procurement_risks: uplift (Med, cap)
- procurement_export_clause_feasible: true
